...
export const ProfileModal = () => {
   const { setUpdateProfileModal, updateProfile, setDeleteProfileModal } =
         ...
         <ModalProfile>
            <form onSubmit={handleSubmit(updateProfile)}>
               ...
               <ErrorMessage
                  errors={errors}
                  name="name"
                  render={() => <span>Mínimo 2 caracteres</span>}
               />
               <TextField
               ...
               <ErrorMessage
                  errors={errors}
                  name="email"
                  render={() => <span>Email inválido</span>}
               />
               <TextField
               ...
               <ErrorMessage
                  errors={errors}
                  name="city"
                  render={() => <span>Mínimo 4 caracteres</span>}
               />
               <TextField
                  multiline={true}
                  minRows={5}
               ...
               <ErrorMessage
                  errors={errors}
                  name="bio"
                  render={() => <span>Mínimo 20 caracteres</span>}
               />
